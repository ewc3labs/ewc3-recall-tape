...
**If RecallTape ever alters or loses note content, report it immediately and label it clearly.** That
is the one failure mode this project treats as critical, and it will be looked at before anything else.

## Related

- [OneMore](https://github.com/stevencohn/OneMore) — the excellent OneNote add-in this work builds on
- [EWC3 Labs](https://github.com/ewc3labs) — the rest of the workshop
